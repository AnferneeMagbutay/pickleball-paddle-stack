# rotation-queue Specification

## Purpose

Maintain a single shared queue of players that feeds one or two courts, randomize partners each game, return players result-blind to the back of the queue, and warn when the group is too small to avoid back-to-back games.
